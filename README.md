...
- Nov 2022: For testing our agents, we use a slightly adapted version of the Pybullet-M benchmark (see Mann et al. below). This updated benchmark code is integrated in our repository and can be found under `/pybullet_m`.

...
config_path = os.path.join(ROOT_DIR, "configs", "ant_attention_sac.json")
...
if config.train:
    ...
    # env.robot._p.startStateLogging(p.STATE_LOGGING_VIDEO_MP4, os.path.join(video_path, str(int(time.time())) + ".mp4"))
    saver = DataSaver()

...
from pybullet_m.helpers.xml_generator import perturb_half_cheetah_xml
...
class RandomPerturbationHalfCheetahBulletEnv(CustomHalfCheetahBulletEnv):
    ...
    def __init__(
        ...
        self.temp_dir = os.path.join(ROOT_DIR, "pybullet_m", "xmls", "half_cheetah", "temp")
        os.makedirs(self.temp_dir, exist_ok=True)
        self.base_xml_path = os.path.join(
            ROOT_DIR, "pybullet_m", "xmls", "half_cheetah", "half_cheetah.xml"
        )
...
class RMAHalfCheetahBulletEnv(RandomPerturbationHalfCheetahBulletEnv, HistoryMixin):
    """Half Cheetah environment selecting a random perturbation at the beginning of each episode.

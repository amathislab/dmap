...
from pybullet_m.helpers.xml_generator import perturb_ant_xml
...
class RandomPerturbationAntBulletEnv(CustomAntBulletEnv):
    ...
    def __init__(
        ...
        self.temp_dir = os.path.join(ROOT_DIR, "pybullet_m", "xmls", "ant", "temp")
        os.makedirs(self.temp_dir, exist_ok=True)
        self.base_xml_path = os.path.join(ROOT_DIR, "pybullet_m", "xmls", "ant", "ant.xml")
...
class RMAAntBulletEnv(RandomPerturbationAntBulletEnv, HistoryMixin):
    """Ant environment selecting a random perturbation at the beginning of each episode.
